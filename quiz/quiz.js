...
var $indicators = $('<ol>')
  ...
  */
    ...
    $.each(question.answers, function(answer_index, answer) {
      ...
      if (correct) {
        ...
        opts = $.extend(opts, {
          title: "Poxa!",
          text: (
            "Não é a alternativa correta!<br/><br/>" +
            "A resposta é \"" +
      ...
      if (last_question) {
        opts.confirmButtonText = "Veja seu resultado!";
      }
  ...
  var $social = $("<div>")
    ...
    .html('<div id = "social-text"> Gostou do resultado? Compartilhe com seus amigos para que eles também testem seus conhecimentos. </div>')
    .appendTo($results_slide);
...
function resultsText(state) {
  ...
  switch (true) {
    case (ratio === 1):
      ...
      break;
    case (ratio > 0.9):
      text = "Incrível! Acertou quase tudo.";
      break;
    case (ratio > 0.60):
      text = "Muito bom! Está quase lá.";
      break;
    case (ratio > 0.5):
      text = "Bom, acertou metade. Nada mal!;";
      break;
    case (ratio < 0.5 && ratio !== 0):
      text = "Parece que não foi fácil, boa sorte na próxima.";
      break;
    case (ratio === 0):
      text = "Não desista. Só precisa estudar mais um pouco!";
      break;
  }
  return text;
